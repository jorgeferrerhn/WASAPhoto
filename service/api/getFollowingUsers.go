...
func (rt *_router) getFollowingUsers(w http.ResponseWriter, r *http.Request, ps httprouter.Params, ctx reqcontext.RequestContext) {
	...
	followingUsers, err2 := rt.db.GetFollowingUsers(user.ToDatabase())
	...
	err3 := json.NewEncoder(w).Encode(followingUsers)
	if err3 != nil {
