  ...
  <div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="h3">Introduce the ID of the photo you want to unlike...: </h3>
        ...
        <a href="javascript:" class="btn btn-primary" @click="unlikePhoto">Unlike</a>
      </div>
    </div>
